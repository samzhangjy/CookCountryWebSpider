...
# @Last Modified time: 2020-05-06 11:35:53
"""
...
def storeToDatabase(result):
    ...
    try:
        ...
        #     (case_id,)
        # )
        sql = """INSERT INTO `%s` (case_id, defendants, plaintiffs, filing_date, case_activity)
        VALUES ('%s', '%s', '%s', '%s', "%s");""" % (DATABASE_TABLE, case_id, plaintiffs, defendants, filing_date, case_activity)
        # Execute the SQL
        cursor.execute(sql)
